...
Pointer<TfLiteInterpreter> Function(Pointer<TfLiteModel> model,
    ...
    tfLiteInterpreterCreate = tflitelib
        .lookup<NativeFunction<TfLiteInterpreterCreatenativet>>(
            'TfLiteInterpreterCreate')
        .asFunction();

typedef TfLiteInterpreterCreatenativet = Pointer<TfLiteInterpreter> Function(
    Pointer<TfLiteModel> model,
    Pointer<TfLiteInterpreterOptions> optionalOptions);

/// Destroys the interpreter.
void Function(Pointer<TfLiteInterpreter>) tfLiteInterpreterDelete = tflitelib
    .lookup<NativeFunction<TfLiteInterpreterDeletenativet>>(
        'TfLiteInterpreterDelete')
    .asFunction();

typedef TfLiteInterpreterDeletenativet = Void Function(
    Pointer<TfLiteInterpreter>);

/// Returns the number of input tensors associated with the model.
int Function(Pointer<TfLiteInterpreter>) tfLiteInterpreterGetInputTensorCount =
    tflitelib
        .lookup<NativeFunction<TfLiteInterpreterGetInputTensorCountnativet>>(
            'TfLiteInterpreterGetInputTensorCount')
        .asFunction();

typedef TfLiteInterpreterGetInputTensorCountnativet = Int32 Function(
    Pointer<TfLiteInterpreter>);
...
Pointer<TfLiteTensor> Function(
    ...
    tfLiteInterpreterGetInputTensor = tflitelib
        .lookup<NativeFunction<TfLiteInterpreterGetInputTensornativet>>(
            'TfLiteInterpreterGetInputTensor')
        .asFunction();

typedef TfLiteInterpreterGetInputTensornativet = Pointer<TfLiteTensor>
...
int Function(Pointer<TfLiteInterpreter> interpreter, int inputIndex,
    ...
    tfLiteInterpreterResizeInputTensor = tflitelib
        .lookup<NativeFunction<TfLiteInterpreterResizeInputTensornativet>>(
            'TfLiteInterpreterResizeInputTensor')
        .asFunction();

typedef TfLiteInterpreterResizeInputTensornativet
...
int Function(Pointer<TfLiteInterpreter>) tfLiteInterpreterAllocateTensors =
    tflitelib
        .lookup<NativeFunction<TfLiteInterpreterAllocateTensorsnativet>>(
            'TfLiteInterpreterAllocateTensors')
        .asFunction();

typedef TfLiteInterpreterAllocateTensorsnativet = /*TfLiteStatus*/ Int32
...
int Function(Pointer<TfLiteInterpreter>) tfLiteInterpreterInvoke = tflitelib
    .lookup<NativeFunction<TfLiteInterpreterInvokenativet>>(
        'TfLiteInterpreterInvoke')
    .asFunction();

typedef TfLiteInterpreterInvokenativet = /*TfLiteStatus*/ Int32 Function(
    Pointer<TfLiteInterpreter>);
...
int Function(
    ...
    .lookup<NativeFunction<TfLiteInterpreterGetOutputTensorCountnativet>>(
        'TfLiteInterpreterGetOutputTensorCount')
    .asFunction();

typedef TfLiteInterpreterGetOutputTensorCountnativet = Int32 Function(
    Pointer<TfLiteInterpreter>);
...
Pointer<TfLiteTensor> Function(
    ...
    tfLiteInterpreterGetOutputTensor = tflitelib
        .lookup<NativeFunction<TfLiteInterpreterGetOutputTensornativet>>(
            'TfLiteInterpreterGetOutputTensor')
        .asFunction();

typedef TfLiteInterpreterGetOutputTensornativet = Pointer<TfLiteTensor>
